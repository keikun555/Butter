...
class Butter(object):
    ...
    def _lowpassFilterVariables(self):
        ...
        # Op = 2 * math.atan(math.pi * self.fc / self.fs) # Replaced with one line below 2017.07.20 Thu
    ...
    def _highpassFilterVariables(self):
        ...
        """
        basic = self._basicFilterVariables()
        # Op = 2 * math.atan(math.pi * float(self.fc) / self.fs) # Replaced with one line below 2017.07.20 Thu
    ...
    def _bandpassFilterVariables(self):
        ...
        """
        basic = self._basicFilterVariables()
        # Op1 = 2 * math.atan(math.pi * float(self.f1) / self.fs) # Replaced with one line below 2017.07.20 Thu
        Op1 = 2 * math.pi * float(self.f1) / self.fs
        # Op2 = 2 * math.atan(math.pi * float(self.f2) / self.fs) # Replaced with one line below 2017.07.20 Thu
        Op2 = 2 * math.pi * float(self.f2) / self.fs
        # vp = 2 * math.atan(self.wc / 2.0)
        alpha = math.cos((Op2 + Op1) / 2.0) / math.cos((Op2 - Op1) / 2.0)
        # k = math.tan(vp / 2.0) / math.tan((Op2 - Op1) / 2.0) # Replaced with one line below 2017.07.20 Thu
    ...
    def _notchFilterVariables(self):
        ...
        # Op1 = 2 * math.atan(math.pi * f1 / self.fs) # Replaced with one line below 2017.07.20 Thu
        Op1 = 2 * math.pi * f1 / self.fs
        # Op2 = 2 * math.atan(math.pi * f2 / self.fs) # Replaced with one line below 2017.07.20 Thu
    ...
    def _bandstopFilterVariables(self):
        ...
        """
        basic = self._basicFilterVariables()
        # Op1 = 2 * math.atan(math.pi * self.f1 / self.fs) # Replaced with one line below 2017.07.20 Thu
        Op1 = 2 * math.pi * self.f1 / self.fs
        # Op2 = 2 * math.atan(math.pi * self.f2 / self.fs) # Replaced with one line below 2017.07.20 Thu

...
#define FREEN(x) do { free((char *)(x)); (x) = NULL; } while(0)
/* #define FREEN(x) if ((char *)(x) != NULL) do { free((char *)(x)); (x) = NULL; } while(0) */

/* The follwoing constants are added 2016.03.11 Fri */
#define LoConst1 36
#define LoConst2  2
